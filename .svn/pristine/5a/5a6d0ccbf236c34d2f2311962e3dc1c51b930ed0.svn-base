...
namespace EasyTools.Framework.UI
{
    ...
    {
        public static DependencyProperty CommandParameterProperty = DependencyProperty.RegisterAttached("CommandParameter", typeof(object), typeof(BindingCommand));
        public static DependencyProperty CommandProperty = DependencyProperty.RegisterAttached("Command", typeof(ICommand), typeof(BindingCommand));
        public static DependencyProperty EventProperty = DependencyProperty.RegisterAttached("Event", typeof(string), typeof(BindingCommand), new PropertyMetadata(PropertyChangedCallback));
        ...
        public static void PropertyChangedCallback(DependencyObject o, DependencyPropertyChangedEventArgs a)
        {
            if (a.Property == EventProperty)
            {
                ...
                if (ev != null)
                {
                    var del = Delegate.CreateDelegate(ev.EventHandlerType, typeof(BindingCommand).GetMethod("EventHandler"));
