...
{
   public class BaseCONErrorViewModel : BaseViewModel
   {

      private readonly CONErrorView view;
      ...
      public override void NewAction()
      {
         try
         {
            Model.Entity = new CONError();
            Model.Details = new BindingList<CONError>();
            Model.CheckAllRules();
            PostNewAction();
         }
         catch (Exception ex)
      ...
      public override async void SaveAction(bool createNew)
      {
         ...
         //      CONError data = ((CONError) await EasyApp.Current.eToolsServer().ExecuteAsync(Model.Entity, (Model.Id == 0 ? Actions.Add : Actions.Modify), Options.Me, EasyApp.Current.DefaultDatabaseSettingName, ""));
         //      if (data != null)
         //      {
      ...
      public override async void DeleteAction()
      {
         ...
         //   {
         //      Model.UpdatedBy = EasyApp.Current.User.Login;
         //      CONError data = ((CONError) await EasyApp.Current.eToolsServer().ExecuteAsync(Model.Entity, Actions.Remove, Options.Me, EasyApp.Current.DefaultDatabaseSettingName, ""));
         //      if (data != null)
      ...
      public virtual void OnDataGridDetailSelectionChange(object sender, DataEventArgs<CONError> e)
      {
         if (e.Value != null)
