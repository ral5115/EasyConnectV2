...
{
   public class BaseWSCONCESIONEViewModel : BaseViewModel
   {

      protected readonly WSCONCESIONEView view;

      protected readonly IUnityContainer container;

      public BaseWSCONCESIONEViewModel(IUnityContainer container,WSCONCESIONEView view)  : base()
      {
         this.view = view;
         this.container = container;
         Model = new WSCONCESIONEModel();
      ...
      private WSCONCESIONEModel model;
      ...
      public virtual void OnDataGridDetailSelectionChange(object sender, DataEventArgs<WSCONCESIONE> e)
      {
         if (e.Value != null)
