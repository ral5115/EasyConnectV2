...
{
   public class WSCONCESIONEViewModel : BaseWSCONCESIONEViewModel
   {

      public WSCONCESIONEViewModel(IUnityContainer container,WSCONCESIONEView view)  : base(container, view)
      {
      }
      ...
      public override void OnDataGridDetailSelectionChange(object sender, DataEventArgs<WSCONCESIONE> e)
      {
