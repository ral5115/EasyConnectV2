...
{
   public class WSEquivalenciasFormasPagoViewModel : BaseWSEquivalenciasFormasPagoViewModel
   {

      public WSEquivalenciasFormasPagoViewModel(IUnityContainer container,WSEquivalenciasFormasPagoView view)  : base(container, view)
      {
      }
