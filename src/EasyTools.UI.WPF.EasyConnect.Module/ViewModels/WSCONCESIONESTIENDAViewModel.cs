...
{
   public class WSCONCESIONESTIENDAViewModel : BaseWSCONCESIONESTIENDAViewModel
   {

      public WSCONCESIONESTIENDAViewModel(IUnityContainer container,WSCONCESIONESTIENDAView view)  : base(container, view)
      {
      }
      ...
      public override void OnDataGridDetailSelectionChange(object sender, DataEventArgs<WSCONCESIONESTIENDA> e)
      {
