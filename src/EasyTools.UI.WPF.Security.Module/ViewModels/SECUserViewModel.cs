...
{
   public class SECUserViewModel : BaseSECUserViewModel
   {

      public SECUserViewModel(IUnityContainer container,SECUserView view)   : base(container, view)
      {
      }
      ...
      public override void OnDataGridDetailSelectionChange(object sender, DataEventArgs<SECUser> e)
      {
