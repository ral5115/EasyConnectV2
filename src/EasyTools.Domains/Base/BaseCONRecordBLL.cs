...
{
    public class BaseCONRecordBLL : IDomainLogic<CONRecord>
    {

        public BaseCONRecordBLL(IUnitOfWork settings)
        {
            Work = settings;
            CommitTransaction = false;
        }

        public BaseCONRecordBLL(DatabaseSetting settings)
        {
        ...
        public override void AddRules(CONRecord data)
        {
            ...
            if (data.Id != 0)
                AddExceptionMessage(Language.DLTABLEIDNULL, "CONRecord");
        }
